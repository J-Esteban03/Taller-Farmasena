    ...
    <div class="sidebar">
      ...
      <nav class="mt-2">
        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
          ...
          <li class="nav-item">
            <a href="<?= base_url('index.php/productos/listado_vendedor');?>" class="nav-link">
  ...
  <div class="content-wrapper">
    ...
    <section class="content">
      ...
      <div class="card">
        ...
        <div class="card-body">
          <div> 
          <!-- application/views/productos/listado_vendedor.php -->

          <h1 class="text-center">Listado de Productos a la Venta</h1>
          <br>
          <?php foreach ($productos as $producto): ?>
              <div class="producto">
                  ...
                  <form action="<?= base_url('index.php/productos/comprar/' . $producto->producto_id) ?>" method="post">
                      <label for="cantidad_deseada">Cantidad a comprar:</label>
                      <input type="number" name="cantidad_deseada" id="cantidad_deseada" required><br>
                      <label for="dinero">Cantidad de dinero:</label>
                      <input type="number" name="dinero" id="dinero" required><br>
