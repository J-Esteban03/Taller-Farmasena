        ...
        <div class="card-body">
          <div> 
            ...
            <table class="table">
              ...
              <tbody>
                <?php foreach ($productos as $key => $producto) :  ?>
                  <tr>
                      <td scope="row"><?php echo $producto->producto_id?></td>
                      ...
                      <td>
                          <a class="btn btn-primary" href="guardar_pro/<?php echo $producto->producto_id?>">Editar</a>
                          
                          <a class="btn btn-info" href="ver_pro/<?php echo $producto->producto_id?>">Ver</a>
                          
                          <a class="btn btn-danger" href="borrar_pro/<?php echo $producto->producto_id?>">Borrar</a>
                      </td>
                  </tr>
                  <?php endforeach ?>
              </tbody>
            ...
            <div class="text-center">
                <a href="guardar_pro"  class="btn btn-success">Crear Producto</a>
            </div>
