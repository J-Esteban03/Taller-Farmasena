        ...
        <div class="card-body">
          ...
          <?php echo form_open(''); ?>
            ...
            <div class="form-group">
              <?php
                echo form_label('Ingrese su username:', 'username');
            ...
            <div class="form-group">
              <?php
                echo "<b>Ingrese su tipo</b>:".'</br>';
                ?>
                <select name="tipo">
                  <option value="ADMIN" <?= set_select('tipo', 'ACTIVO', true) ?>>ACTIVO</option>
                  <option value="VENDEDOR" <?= set_select('tipo', 'VENDEDOR') ?>>INACTIVO</option>
                </select>
            ...
            <div class="form-group">
              <?php
                echo "<b>Ingrese su estado</b>:".'</br>';
                ?>
                <select name="estado">
                  <option value="ACTIVO" <?= set_select('estado', 'ACTIVO', true) ?>>ACTIVO</option>
                  <option value="INACTIVO" <?= set_select('estado', 'INACTIVO') ?>>INACTIVO</option>
                </select>
            ...
            <div class="text-center mt-4">
              <a href="../listado_usu" class="btn btn-success">Cancelar</a>
              <?php
